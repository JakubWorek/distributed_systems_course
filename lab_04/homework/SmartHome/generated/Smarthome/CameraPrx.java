...
public interface CameraPrx extends DevicePrx
{
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Location> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getLocation", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_getLocation);
    ...
    default void setResolution(int resolution, java.util.Map<String, String> context)
        throws DevicesIsInStandbyMode,
               InputResolutionOutOfRange,
               StorageFullError
    {
        ...
        catch(InputResolutionOutOfRange ex)
        {
            throw ex;
        }
        catch(StorageFullError ex)
        {
            throw ex;
        }
        catch(com.zeroc.Ice.UserException ex)
    ...
    default java.util.concurrent.CompletableFuture<Void> setResolutionAsync(int resolution)
    {
        return _iceI_setResolutionAsync(resolution, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setResolutionAsync(int resolution, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setResolutionAsync(int iceP_resolution, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setResolution", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_setResolution);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_resolution);
                 }, null);
        return f;
    }
    ...
    {
        DevicesIsInStandbyMode.class,
        InputResolutionOutOfRange.class,
    ...
    default int getResolution()
        throws DevicesIsInStandbyMode
    {
        return getResolution(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int getResolution(java.util.Map<String, String> context)
        throws DevicesIsInStandbyMode
    {
        try
        {
            return _iceI_getResolutionAsync(context, true).waitForResponseOrUserEx();
        }
        catch(DevicesIsInStandbyMode ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> getResolutionAsync()
    {
        return _iceI_getResolutionAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> getResolutionAsync(java.util.Map<String, String> context)
    {
        return _iceI_getResolutionAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_getResolutionAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getResolution", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_getResolution);
        f.invoke(true, context, null, null, istr -> {
                     int ret;
                     ret = istr.readInt();
                     return ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getResolution =
    {
        DevicesIsInStandbyMode.class
    };

    default double getStorageLevel()
        throws DevicesIsInStandbyMode
    {
        return getStorageLevel(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double getStorageLevel(java.util.Map<String, String> context)
        throws DevicesIsInStandbyMode
    {
        try
        {
            return _iceI_getStorageLevelAsync(context, true).waitForResponseOrUserEx();
        }
        catch(DevicesIsInStandbyMode ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Double> getStorageLevelAsync()
    {
        return _iceI_getStorageLevelAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> getStorageLevelAsync(java.util.Map<String, String> context)
    {
        return _iceI_getStorageLevelAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_getStorageLevelAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getStorageLevel", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_getStorageLevel);
        f.invoke(true, context, null, null, istr -> {
                     double ret;
                     ret = istr.readDouble();
                     return ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getStorageLevel =
    {
        DevicesIsInStandbyMode.class
    };
