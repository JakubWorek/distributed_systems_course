...
if 'InputResolutionOutOfRange' not in _M_Smarthome.__dict__:
    _M_Smarthome.InputResolutionOutOfRange = Ice.createTempClass()
    class InputResolutionOutOfRange(Ice.UserException):
        def __init__(self):
            pass
        ...
        _ice_id = '::Smarthome::InputResolutionOutOfRange'

    _M_Smarthome._t_InputResolutionOutOfRange = IcePy.defineException('::Smarthome::InputResolutionOutOfRange', InputResolutionOutOfRange, (), False, None, ())
    InputResolutionOutOfRange._ice_type = _M_Smarthome._t_InputResolutionOutOfRange

    _M_Smarthome.InputResolutionOutOfRange = InputResolutionOutOfRange
    del InputResolutionOutOfRange

if 'StorageFullError' not in _M_Smarthome.__dict__:
    _M_Smarthome.StorageFullError = Ice.createTempClass()
    class StorageFullError(Ice.UserException):
        def __init__(self):
            pass
        ...
        _ice_id = '::Smarthome::StorageFullError'

    _M_Smarthome._t_StorageFullError = IcePy.defineException('::Smarthome::StorageFullError', StorageFullError, (), False, None, ())
    StorageFullError._ice_type = _M_Smarthome._t_StorageFullError

    _M_Smarthome.StorageFullError = StorageFullError
    del StorageFullError
...
if 'DevicePrx' not in _M_Smarthome.__dict__:
    ...
    Device._op_getId = IcePy.Operation('getId', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), IcePy._t_string, False, 0), ())
    Device._op_setMode = IcePy.Operation('setMode', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), _M_Smarthome._t_Mode, False, 0),), (), None, ())
...
if 'FridgeWithProductsMonitoringPrx' not in _M_Smarthome.__dict__:
    ...
    FridgeWithProductsMonitoring._op_addProduct = IcePy.Operation('addProduct', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Smarthome._t_Product, False, 0),), (), None, (_M_Smarthome._t_DevicesIsInStandbyMode, _M_Smarthome._t_InvalidDate))
    FridgeWithProductsMonitoring._op_addProducts = IcePy.Operation('addProducts', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Smarthome._t_ProductList, False, 0),), (), None, (_M_Smarthome._t_DevicesIsInStandbyMode, _M_Smarthome._t_InvalidDate))
    FridgeWithProductsMonitoring._op_removeProduct = IcePy.Operation('removeProduct', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (), None, (_M_Smarthome._t_DevicesIsInStandbyMode, _M_Smarthome._t_ProductDoesNotExist))
...
if 'FridgeWithIceMakerPrx' not in _M_Smarthome.__dict__:
    ...
    FridgeWithIceMaker._op_makeIce = IcePy.Operation('makeIce', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (), None, (_M_Smarthome._t_DevicesIsInStandbyMode,))
...
if 'ResolutionRange' not in _M_Smarthome.__dict__:
    _M_Smarthome.ResolutionRange = Ice.createTempClass()
    class ResolutionRange(object):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_Smarthome.ResolutionRange):
                return NotImplemented
            else:
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Smarthome._t_ResolutionRange)

        __repr__ = __str__

    _M_Smarthome._t_ResolutionRange = IcePy.defineStruct('::Smarthome::ResolutionRange', ResolutionRange, (), (
        ('min', (), IcePy._t_int),
        ('max', (), IcePy._t_int)
    ))

    _M_Smarthome.ResolutionRange = ResolutionRange
    del ResolutionRange
...
if 'CameraPrx' not in _M_Smarthome.__dict__:
    ...
    class CameraPrx(_M_Smarthome.DevicePrx):
        ...
        def getLocation(self, context=None):
            return _M_Smarthome.Camera._op_getLocation.invoke(self, ((), context))

        def getLocationAsync(self, context=None):
            return _M_Smarthome.Camera._op_getLocation.invokeAsync(self, ((), context))

        def begin_getLocation(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Smarthome.Camera._op_getLocation.begin(self, ((), _response, _ex, _sent, context))

        def end_getLocation(self, _r):
            return _M_Smarthome.Camera._op_getLocation.end(self, _r)

        def setResolution(self, resolution, context=None):
            return _M_Smarthome.Camera._op_setResolution.invoke(self, ((resolution, ), context))

        def setResolutionAsync(self, resolution, context=None):
            return _M_Smarthome.Camera._op_setResolution.invokeAsync(self, ((resolution, ), context))

        def begin_setResolution(self, resolution, _response=None, _ex=None, _sent=None, context=None):
            return _M_Smarthome.Camera._op_setResolution.begin(self, ((resolution, ), _response, _ex, _sent, context))

        def end_setResolution(self, _r):
            return _M_Smarthome.Camera._op_setResolution.end(self, _r)

        def getResolution(self, context=None):
            return _M_Smarthome.Camera._op_getResolution.invoke(self, ((), context))

        def getResolutionAsync(self, context=None):
            return _M_Smarthome.Camera._op_getResolution.invokeAsync(self, ((), context))

        def begin_getResolution(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Smarthome.Camera._op_getResolution.begin(self, ((), _response, _ex, _sent, context))

        def end_getResolution(self, _r):
            return _M_Smarthome.Camera._op_getResolution.end(self, _r)

        def getStorageLevel(self, context=None):
            return _M_Smarthome.Camera._op_getStorageLevel.invoke(self, ((), context))

        def getStorageLevelAsync(self, context=None):
            return _M_Smarthome.Camera._op_getStorageLevel.invokeAsync(self, ((), context))

        def begin_getStorageLevel(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Smarthome.Camera._op_getStorageLevel.begin(self, ((), _response, _ex, _sent, context))

        def end_getStorageLevel(self, _r):
            return _M_Smarthome.Camera._op_getStorageLevel.end(self, _r)
    ...
    class Camera(_M_Smarthome.Device):
        ...
        def getResolution(self, current=None):
            raise NotImplementedError("servant method 'getResolution' not implemented")

        def getStorageLevel(self, current=None):
            raise NotImplementedError("servant method 'getStorageLevel' not implemented")
    ...
    Camera._op_getLocation = IcePy.Operation('getLocation', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), _M_Smarthome._t_Location, False, 0), (_M_Smarthome._t_DevicesIsInStandbyMode,))
    Camera._op_setResolution = IcePy.Operation('setResolution', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), IcePy._t_int, False, 0),), (), None, (_M_Smarthome._t_DevicesIsInStandbyMode, _M_Smarthome._t_InputResolutionOutOfRange, _M_Smarthome._t_StorageFullError))
    Camera._op_getResolution = IcePy.Operation('getResolution', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), IcePy._t_int, False, 0), (_M_Smarthome._t_DevicesIsInStandbyMode,))
    Camera._op_getStorageLevel = IcePy.Operation('getStorageLevel', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), IcePy._t_double, False, 0), (_M_Smarthome._t_DevicesIsInStandbyMode,))
