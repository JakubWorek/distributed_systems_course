...
def main():
    ...
    devices = [
        ...
        Device("Fridge1", "kitchen-devices", "fridge 1", server_ip, kitchen_port, Smarthome.FridgePrx),
        Device("Fridge2", "kitchen-devices", "fridge 2", server_ip, kitchen_port, Smarthome.FridgeWithIceMakerPrx),
        Device("Fridge3", "kitchen-devices", "fridge 3", server_ip, kitchen_port, Smarthome.FridgeWithProductsMonitoringPrx)
    ]
